...
export function FeaturesSection() {
  return (
    <section className="pb-16 pt-10 md:pb-24 md:pt-16 bg-slate-50">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6">
        <SectionHeader
          title={<>Tudo o Que Precisa Para <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Crescer</span></>}
